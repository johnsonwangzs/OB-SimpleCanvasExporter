...
@media(max-width:650px){.sce-count{display:none}.sce-toolbar-main{gap:6px;padding:8px;flex-wrap:wrap}.sce-title-line{flex-basis:100%;gap:8px}.sce-title{font-size:12px;min-width:40px}.sce-controls{gap:3px}button{padding:6px}.sce-search{padding:0 8px 8px;gap:8px}.sce-search-input{flex-basis:100%;max-width:none}.sce-search-status{flex-basis:100%}.sce-search-actions{gap:6px}.sce-help{display:none}}
